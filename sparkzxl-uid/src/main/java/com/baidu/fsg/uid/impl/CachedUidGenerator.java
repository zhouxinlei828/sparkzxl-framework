...
/**
 * Represents a cached implementation of {@link UidGenerator} extends from {@link DefaultUidGenerator}, based on a lock free
 * {@link RingBuffer}<p>
 * <p>
 ...
 * will be <code>({@link BitsAllocator#getMaxSequence()} + 1) &lt;&lt; {@link #boostPower}</code>, Default as {@value #DEFAULT_BOOST_POWER}
 * <li><b>paddingFactor:</b> Represents a percent value of (0 - 100). When the count of rest available UIDs reach the
 * threshold, it will trigger padding buffer. Default as{@link RingBuffer#DEFAULT_PADDING_PERCENT} Sample: paddingFactor=20, bufferSize=1000
