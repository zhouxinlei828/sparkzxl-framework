...
import com.github.sparkzxl.gateway.response.strategy.ExceptionHandlerStrategyAdapter;
            ...
            if (CollectionUtils.isEmpty(annotatedMethods)) {
                ...
                for (Method method : annotatedMethods.keySet()) {
                    ...
                    for (Class clazz : parameterTypes) {
                        if (!ClassUtils.isAssignable(Throwable.class, clazz)) {
                            throw new IllegalArgumentException("Exception Handler Parameters Must Be Throwable");
                        }
                    }
