...
import com.github.sparkzxl.data.sync.nacos.NacosDataSyncServiceImpl;
...
@ConditionalOnProperty(prefix = ConfigConstant.DATA_SYNC_CONSUMER_PREFIX + "nacos", name = "enabled", havingValue = "true")
public class NacosConsumerAutoConfig {

    private static final Logger logger = LoggerFactory.getLogger(NacosConsumerAutoConfig.class);
