...
public class FeignExceptionHandler extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(WebRequest webRequest, boolean includeStackTrace) {
        ...
        return r(status, message, exceptionChains);
    }
     ...
     */
    public static Map<String, Object> r(int status, String errorMessage, List<ExceptionChain> exceptionChains) {
...
public class FeignExceptionDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response r) {
        try {
            Reader reader = r.body().asReader(StandardCharsets.UTF_8);
