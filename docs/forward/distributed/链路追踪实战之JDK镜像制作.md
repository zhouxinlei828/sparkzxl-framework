...
![jdk-download.png](https://oss.sparksys.top/sparkzxl-framework/jdk-download.png)
...
![skywalking-download.png](https://oss.sparksys.top/sparkzxl-framework/skywalking-download.png)
...
![skywalking-agent.png](https://oss.sparksys.top/sparkzxl-framework/skywalking-agent.png)

文件结构如下

![jdk-build.png](https://oss.sparksys.top/sparkzxl-framework/jdk-build.png)
