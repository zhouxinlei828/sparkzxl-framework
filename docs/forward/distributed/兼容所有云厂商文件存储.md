# 「一站式」兼容所有云厂商文件存储Spring Boot实现

摘要: 原创出处 https://juejin.cn/post/6857693474490155022 「冷冷zz」
...
|名称|地址
|-------|-------|
|阿里云oss|https://help.aliyun.com/document_detail/31947.html|
|华为云|https://www.huaweicloud.com|
|腾讯云|https://cloud.tencent.com|
|七牛云|https://www.qiniu.com|
|金山云|https://www.ksyun.com|

## 3. 使用Amazon S3构建通用starter

### 3.1 新建sparkzxl-oss-starter项目

![sparkzxl-oss-starter.png](../../images/sparkzxl-oss-starter-idea.png)
...
- 在resource目录新建META-INF目录

> 在META-INF目录下新建spring.factories

- spring.factories添加config
...
## 4. 组件使用
### 4.1 使用
在[maven中央仓库](https://search.maven.org/) 搜索sparkzxl-oss-starter

![nexus-sparkzxl-oss-starter.png.png](../../images/nexus-sparkzxl-oss-starter.png)
