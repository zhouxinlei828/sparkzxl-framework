...
![spring-boot-jenkins.png](https://oss.sparksys.top/sparkzxl-framework/spring-boot-jenkins.png)
...
![jenkins-Pipeline-Pipeline.png](https://oss.sparksys.top/sparkzxl-framework/jenkins-Pipeline.png)

### 配置流水线任务

![Pipeline-config.png](https://oss.sparksys.top/sparkzxl-framework/Pipeline-config.png)
...
![run-pipeline.png](https://oss.sparksys.top/sparkzxl-framework/run-pipeline.png)

- 运行流水线任务

![run-pipeline-1.png](https://oss.sparksys.top/sparkzxl-framework/run-pipeline-1.png)

- 查看运行结果

![run-pipeline-result.png](https://oss.sparksys.top/sparkzxl-framework/run-pipeline-result.png)
